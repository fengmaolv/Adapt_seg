      ...
      #  loss_weakly_value = 0
        ...
        for sub_i in range(args.iter_size):
         ...
         #   print("fengmao:",class_label_target)
            ...
            mask_target = class_label_target * SEQ.type(torch.FloatTensor)
            ...
            loss_weak = F.cross_entropy(pred_target, labels_target.cuda(args.gpu))
            
            loss_seg = loss_calc(pred, labels, args.gpu)

            loss =  loss_seg + loss_weak # + args.lambda_seg * loss_seg1
