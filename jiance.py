...
from dataset.gta5_dataset_weakly_test import GTA5DataSet
    ...
    for i_iter in range(args.num_steps):
       ...
       # loss_seg_value1 = 0
        ...
        for sub_i in range(args.iter_size):
            ...
            lse  = (1.0/0.001) * torch.log(AvePool(torch.exp(0.001*pred)))
            aaa=torch.log(AvePool(torch.exp(0.001*pred)))  
            print(torch.max(pred[0][0]), torch.min(pred[0][0]),aaa[0][0]) 
